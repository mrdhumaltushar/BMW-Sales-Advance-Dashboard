...
## 📂 Repository Contents
- **`Data/`**: Contains the raw `BMW Sales.csv` dataset used for this analysis.
- **`Reports/`**: Contains the full `BMW Dashboard.pdf` export of the Power BI report.

## 🚀 How to Use
Since this repository focuses on the *analysis output* and *data availability*:

1. **View the Analysis:** Open the `Reports/BMW Dashboard.pdf` file to see the full visualized report.
